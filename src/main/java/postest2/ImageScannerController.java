...
public class ImageScannerController extends CommonController implements Initializable {
	...
	public void handleDeviceEnable(ActionEvent e) {
		try {
			if (deviceEnabled.isSelected()) {
				((ImageScanner) service).setDeviceEnabled(true);
			} else {
	...
	public void handleStatistics(ActionEvent e) {
		JOptionPane.showMessageDialog(null, "Class ImageScanner is not implemented!");
		/*
		String[] stats = new String[] { "", "U_", "M_" };
		try {
			((ImageScanner) service).retrieveStatistics(stats);
