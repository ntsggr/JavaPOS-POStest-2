...
public class POSPrinterConstantMapper {
	...
	public static final ConstantConverter PTR_COLOR_PRIMARY = new ConstantConverter(0x00000001, "PTR_COLOR_PRIMARY");
	public static final ConstantConverter PTR_COLOR_CUSTOM1 = new ConstantConverter(0x00000002, "PTR_COLOR_CUSTOM1");
	public static final ConstantConverter PTR_COLOR_CUSTOM2 = new ConstantConverter(0x00000004, "PTR_COLOR_CUSTOM2");
	public static final ConstantConverter PTR_COLOR_CUSTOM3 = new ConstantConverter(0x00000008, "PTR_COLOR_CUSTOM3");
	public static final ConstantConverter PTR_COLOR_CUSTOM4 = new ConstantConverter(0x00000010, "PTR_COLOR_CUSTOM4");
	public static final ConstantConverter PTR_COLOR_CUSTOM5 = new ConstantConverter(0x00000020, "PTR_COLOR_CUSTOM5");
	public static final ConstantConverter PTR_COLOR_CUSTOM6 = new ConstantConverter(0x00000040, "PTR_COLOR_CUSTOM6");
	public static final ConstantConverter PTR_COLOR_CYAN = new ConstantConverter(0x00000100, "PTR_COLOR_CYAN");
	public static final ConstantConverter PTR_COLOR_MAGENTA = new ConstantConverter(0x00000200, "PTR_COLOR_MAGENTA");
	public static final ConstantConverter PTR_COLOR_YELLOW = new ConstantConverter(0x00000400, "PTR_COLOR_YELLOW");
	...
	public static final ConstantConverter PTR_PM_BM_ROTATE = new ConstantConverter(0x00000004, "PTR_PM_BM_ROTATE");
	public static final ConstantConverter PTR_PM_BC_ROTATE = new ConstantConverter(0x00000008, "PTR_PM_BC_ROTATE");
	...
	public static final ConstantConverter PTR_PD_LEFT_TO_RIGHT = new ConstantConverter(1, "PTR_PD_LEFT_TO_RIGHT");
	public static final ConstantConverter PTR_PD_BOTTOM_TO_TOP = new ConstantConverter(2, "PTR_PD_BOTTOM_TO_TOP");
	public static final ConstantConverter PTR_PD_RIGHT_TO_LEFT = new ConstantConverter(3, "PTR_PD_RIGHT_TO_LEFT");
	public static final ConstantConverter PTR_PD_TOP_TO_BOTTOM = new ConstantConverter(4, "PTR_PD_TOP_TO_BOTTOM");
	...
	public static final ConstantConverter PTR_BCS_Code128_Parsed = new ConstantConverter(123, "PTR_BCS_Code128_Parsed");
	...
	public static final ConstantConverter PTR_BCS_RSS14 = new ConstantConverter(131, "PTR_BCS_RSS14"); // Reduced
																									...
																									// digit
																									// GTIN
	public static final ConstantConverter PTR_BCS_RSS_EXPANDED = new ConstantConverter(132, "PTR_BCS_RSS_EXPANDED"); // RSS
																											// -
																											// 14
																											// digit
																											// GTIN
	...
	public static final ConstantConverter PTR_BCS_GS1DATABAR = new ConstantConverter(131, "PTR_BCS_GS1DATABAR"); // GS1
																										// DataBar
																										// Omnidirectional
	public static final ConstantConverter PTR_BCS_GS1DATABAR_E = new ConstantConverter(132, "PTR_BCS_GS1DATABAR_E"); // GS1
																											// DataBar
																											// Expanded
	public static final ConstantConverter PTR_BCS_GS1DATABAR_S = new ConstantConverter(133, "PTR_BCS_GS1DATABAR_S"); // GS1
																											// DataBar
																											// Stacked
																											// Omnidirectional
	public static final ConstantConverter PTR_BCS_GS1DATABAR_E_S = new ConstantConverter(134, "PTR_BCS_GS1DATABAR_E_S"); // GS1
																											// DataBar
																											// Expanded
																											// Stacked
	...
	public static final ConstantConverter PTR_BCS_DATAMATRIX = new ConstantConverter(203, "PTR_BCS_DATAMATRIX"); // Data
																										// Matrix
	...
	public static final ConstantConverter PTR_MF_TO_CURRENT_TOF = new ConstantConverter(4, "PTR_MF_TO_CURRENT_TOF");
	...
	public static final ConstantConverter PTR_LS_SINGLE_SOLID_LINE = new ConstantConverter(1, "PTR_LS_SINGLE_SOLID_LINE"); // Added
																											// in
																											// 1.13
	public static final ConstantConverter PTR_LS_DOUBLE_SOLID_LINE = new ConstantConverter(2, "PTR_LS_DOUBLE_SOLID_LINE"); // Added
																											// in
																											// 1.13
